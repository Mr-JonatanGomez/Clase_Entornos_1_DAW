...
public class NadadorTestParametrizados2 {
    ...
    public void testPuntuacionFinal(Nadador nadador, float expectedPuntuacionFinal) {
        ...
        assertEquals(expectedPuntuacionFinal, actualPuntuacionFinal, 0.01f);
        //delta es el margen de error aceptable
    }

    private static Collection<Object[]> provideNadadores() {
        return Arrays.asList(new Object[][]{
                {new Nadador("Nadador1", 7.50f, 3.20f), 24.00f,"HA FALLADO"},
